...
class GetCartoonsUseCase(override val repository: ContentViewRepository) : InOutCase<GetContentModel,Deferred<Result<List<ContentItem>>>, ContentViewRepository>() {
